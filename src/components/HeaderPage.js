...
function ResponsiveAppBar({ loading, user }) {
          ...
          <Box sx={ { flexGrow: 0 } }>
            <Tooltip title="Open settings">
              <IconButton onClick={ handleOpenUserMenu } sx={ { p: 0 } }>
                <Avatar alt="Remy Sharp" src="" sx={ { marginRight: 1 } } />
                { loading ? <Loading /> : (
                  <p className="profile-name" data-testid="header-user-name">
                    {user.name}
                  </p>)}
              </IconButton>
            </Tooltip>
